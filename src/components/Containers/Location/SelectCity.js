        ...
        return (
            <ScrollView contentContainerStyle={{flexGrow: 1, padding: 15}} style={{backgroundColor: '#FBFBFB'}}>
                <View style={{paddingBottom: 15}}>
                    <Text style={{color: SITE_COLOR, fontSize: 20}}>Select city</Text>
                    <Hr style={{marginTop: 15, backgroundColor: '#707070'+calculateOpacity(53)}}/>
                </View>
                <CityAreaSection name={'Enugu'} />
                <CityAreaSection name={'Abia'} />
                <CityAreaSection name={'Lagos'} />
                <CityAreaSection name={'Abuja'} />
            </ScrollView>
        );
